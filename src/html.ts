            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="#features" class="text-gray-500 hover:text-gray-900 px-4 py-2 rounded-md text-sm font-medium">Features</a>
                        <a href="#getting-started" class="text-gray-500 hover:text-gray-900 px-4 py-2 rounded-md text-sm font-medium">Getting Started</a>
                        <a href="/docs/api" class="text-gray-500 hover:text-gray-900 px-4 py-2 rounded-md text-sm font-medium">API</a>
    ...
    <section id="api" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="/docs/api" class="inline-flex items-center px-10 py-5 border border-transparent text-xl font-bold rounded-lg text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
