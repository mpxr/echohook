...
<body class="bg-gray-50 text-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="text-2xl font-bold text-pink-600">🪝 EchoHook</div>
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="#features" class="text-gray-500 hover:text-pink-600 px-4 py-2 rounded-md text-sm font-medium transition-colors">Features</a>
                        <a href="#getting-started" class="text-gray-500 hover:text-pink-600 px-4 py-2 rounded-md text-sm font-medium transition-colors">Getting Started</a>
                        <a href="/docs/api" class="text-gray-500 hover:text-pink-600 px-4 py-2 rounded-md text-sm font-medium transition-colors">API</a>
                        <a href="https://github.com/mpxr/echohook" class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-pink-600 hover:to-purple-700 transition-all">GitHub</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                ...
                <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                    ...
                    <span class="block text-pink-200">Webhook Bin Service</span>
                </h1>
                <p class="mt-3 max-w-md mx-auto text-base text-white/90 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    Capture, inspect and debug HTTP webhooks with ease.
                </p>
                <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                    <div class="rounded-md shadow">
                        <a href="#getting-started" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-pink-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 transition-colors">
                            Get Started
                        </a>
                    </div>
                    <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                        <a href="#features" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-pink-500 hover:bg-pink-600 md:py-4 md:text-lg md:px-10 transition-colors">
                            Learn More
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-20">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="feature-card glass-card rounded-lg p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-pink-500 text-white text-2xl">
                                    🔐
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="feature-card glass-card rounded-lg p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-cyan-500 text-white text-2xl">
                                    📡
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="feature-card glass-card rounded-lg p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white text-2xl">
                                    📦
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="feature-card glass-card rounded-lg p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-cyan-600 text-white text-2xl">
                                    ⚡
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="feature-card glass-card rounded-lg p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-pink-600 text-white text-2xl">
                                    🔌
                                </div>
                            </div>
                            <div class="ml-4">
  ...
  -d '{"name": "My Token"}'</code></pre>
                    ...
                    <!-- Step 2 -->
                    <div class="text-center">
                        <div class="flex items-center justify-center h-16 w-16 rounded-full bg-purple-100 text-purple-600 text-2xl font-bold mx-auto mb-4">
                            2
                        </div>
  ...
  -d '{"name": "Test Bin"}'</code></pre>
                    ...
                    <!-- Step 3 -->
                    <div class="text-center">
                        <div class="flex items-center justify-center h-16 w-16 rounded-full bg-cyan-100 text-cyan-600 text-2xl font-bold mx-auto mb-4">
                            3
                        </div>
    ...
    <section id="api" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="px-6 py-4 flex items-center justify-between">
                            <div class="flex items-center">
                                <span class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-800 mr-3 min-w-[50px]">POST</span>
                        ...
                        <div class="px-6 py-4 flex items-center justify-between">
                            <div class="flex items-center">
                                <span class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-cyan-100 text-cyan-800 mr-3 min-w-[50px]">GET</span>
            ...
            <div class="mt-12 text-center">
                <a href="/docs/api" class="inline-flex items-center px-10 py-5 border border-transparent text-xl font-bold rounded-lg text-white bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                ...
                <div class="mt-8 flex justify-center space-x-4">
                    <a href="#getting-started" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-pink-600 bg-white hover:bg-gray-50 transition-colors">
                        Get Started
                    </a>
                    <a href="https://github.com/mpxr/echohook" class="inline-flex items-center px-6 py-3 border border-white text-base font-medium rounded-md text-white bg-transparent hover:bg-white hover:text-pink-600 transition-colors">
